...
DEFAULT_FAQ = [
    {
        ...
        "answer": "We offer premium courses on Cloud Computing, Web Developmentand Voice AI Agent development. We also sell 'Cloud Ninja' merchandise like hoodies and mugs."
    },
    {
    ...
    },
    {
        ...
        "answer": "Yes! Dhruva releases weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Dhruva Store'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Dhruva and email you." (Don't hallucinate prices).
            """,
