  ...
  return (
    <button
      ...
      className={cn(
        ...
        'bg-neutral-900 text-neutral-100 shadow-md transition-all',
        'hover:bg-neutral-800 focus:outline-none'
      )}
    >
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v1m0 16v1m9-9h1M3 12H2m16.24-7.76l-.707.707M7.76 20.24l-.707-.707M20.24 16.24l-.707.707M4.464 4.464l-.707-.707" />
      </svg>
    </button>
  );
}
